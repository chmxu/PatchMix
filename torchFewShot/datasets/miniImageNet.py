...
class miniImageNet(object):
    ...
    """
    #dataset_dir = '/home/xuchengming/XCM/Datasets/miniimagenet'
    dataset_dir = '/mnt/tmp/miniimagenet'
    #dataset_dir = '/youtu_action_data/chengmingxu/data/miniImageNet/miniimagenet/'
